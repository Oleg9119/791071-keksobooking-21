...
(() => {
  ...
  window.createCard = (ad) => {
    ...
    clonedMapCardType.textContent = `${window.getLocalType(ad.offer.type)}`;
    ...
    const mapCardPhotoFragment = window.renderCardPhotos(clonedMapCardPhotos, ad.offer.photos);
